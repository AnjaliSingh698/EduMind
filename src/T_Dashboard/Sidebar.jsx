...
//           <Link
//             to="/teacherdashboard"
//             className="block px-4 py-2 rounded-xl text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition"
//           >
//             Dashboard
//           </Link>
//         </li>
...
//   className="mt-4 w-full px-4 py-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100"
// >
//   Logout
// </button>
//       {/* Bottom Section */}
