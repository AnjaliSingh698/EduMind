...
//       <div className="ml-64 mt-15 p-8 w-full">
...
//                   📘 Subject:{" "}
//                   {quiz.subject?.name || quiz.subject || "N/A"}
//                 </p>
...
//                     className="px-4 py-2 bg-white border-2 border-red-500 text-red-500 rounded-lg hover:bg-red-100 transition"
//                   >
//                     Delete
//                   </button>
//                 </div>
