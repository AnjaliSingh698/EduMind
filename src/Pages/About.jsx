...
//       desc: "Generate high-quality quizzes in seconds using AI. Save hours of manual effort while ensuring relevant and structured questions.",
//       icon: "🤖",
//     },
//     {
//       title: "Real-time Analytics",
//       desc: "Track student performance instantly with detailed insights, progress tracking, and weak-area detection.",
//       icon: "📊",
//     },
//     {
//       title: "Teacher Dashboard",
//       desc: "Manage quizzes, students, and results from a powerful centralized dashboard designed for educators.",
//       icon: "🧑‍🏫",
//     },
//     {
//       title: "Personalized Learning",
//       desc: "Students get tailored feedback and recommendations based on their quiz performance.",
//       icon: "✨",
//     },
//   ];
...
//       desc: "Give educators smart tools to reduce workload and focus more on teaching.",
//       icon: "👩‍🏫",
//     },
//     {
//       title: "Enhance Learning",
//       desc: "Make learning interactive, adaptive, and AI-driven for better understanding.",
//       icon: "🎯",
//     },
//     {
//       title: "Save Time",
//       desc: "Automate repetitive academic tasks and improve efficiency for both students and teachers.",
//       icon: "⏱️",
//     },
//   ];
...
//           Welcome to <span className="text-indigo-600">EduMind</span>
//         </h1>

//         <p className="text-gray-600 mt-4 leading-relaxed">
//           We’re building a smarter way for teachers to teach and students to learn—powered by intelligent AI technology.
//         </p>
//       </div>
...
//         <div className="max-w-3xl mx-auto bg-indigo-50 border border-indigo-100 rounded-2xl p-10 shadow-sm">
//           <h3 className="text-2xl font-semibold">
//             Start using EduMind today 🚀
//           </h3>
//           <p className="text-gray-600 mt-2">
//             This is a full-stack quiz management system built using the MERN stack. It allows teachers to create, manage, and analyze quizzes, while students can attempt quizzes and view their results in real time. The system is designed to provide a smooth and responsive user experience with secure backend APIs.
//           </p>
